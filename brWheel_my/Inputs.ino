...
static inline bool readButtonPin(uint8_t pin) {
...
#if defined(ARDUINO_ARCH_RP2040)
  switch (i) {
    case 0: return readButtonPin(BUTTON0);
    case 1: return readButtonPin(BUTTON1);
    case 2: return readButtonPin(BUTTON2);
    case 3: return readButtonPin(BUTTON3);
    case 4: return readButtonPin(BUTTON4);
    case 5: return readButtonPin(BUTTON5);
    case 6: return readButtonPin(BUTTON6);
#ifndef USE_LOAD_CELL
    case 7: return readButtonPin(BUTTON7);
#endif
#ifdef USE_EXTRABTN
    case 8: return readButtonPin(BUTTON8);
    case 9: return readButtonPin(BUTTON9);
#endif
