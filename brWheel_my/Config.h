...
#if defined(ARDUINO_ARCH_RP2040) && defined(USE_DSP56ADC16S)
#error "USE_DSP56ADC16S uses AVR-specific SPI/timer registers and is not supported on RP2040."
#endif
...
#if defined(ARDUINO_ARCH_RP2040)
// RP2040 (XIAO RP2040) default pin mapping.
// TODO: adjust these to your wiring/pinout.
#define FFBCLIP_LED_PIN LED_BUILTIN

// Encoder pins (adjust to match your encoder wiring)
#define QUAD_ENC_PIN_A 2
#define QUAD_ENC_PIN_B 3
#define QUAD_ENC_PIN_I 4

// Analog inputs (A0-A3 on RP2040 core)
#define ACCEL_PIN A0
#define BRAKE_PIN A1
...
// Shift register (if used)
#define SHIFTREG_PL 14
#define SHIFTREG_CLK 15
#define SHIFTREG_DATA_SW 16
